...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER trg_tickets_close_completes_task
AFTER UPDATE ON tickets FOR EACH ROW
BEGIN
  IF NEW.status='closed' AND OLD.status <> 'closed' THEN
    UPDATE tasks
      SET status='completed', completed_at=NOW()
      WHERE linked_ticket_id = NEW.id AND status <> 'completed';
  END IF;
END */;;
DELIMITER ;
...
--
-- Dumping events for database 'w17_ticketing'
--
...
-- Dump completed on 2025-10-08 14:22:03
